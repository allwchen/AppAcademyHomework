...
def ordered_vowel_word?(word)
  vowels="aeiou"
  word_vowels = word.downcase.chars.select{ |char| vowels.include?(char) }
  return word_vowels == word_vowels.sort
end

# puts ordered_vowel_word?("a")
# puts ordered_vowel_word?("ae")
# puts ordered_vowel_word?("ea")
# puts ordered_vowel_word?("abe")
# puts ordered_vowel_word?("be")
...
def products_except_me(numbers)
  # remaining = []
  # numbers.each do |num|
  #   remaining << array_product(numbers.reject{ |n| n==num})
  # end
  # return remaining
...
# puts array_product([2,3,4])
# puts array_product([1, 2,3,5])
